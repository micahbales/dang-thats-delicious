...
exports.getStores = async (req, res) => {
  ...
  // if a user visits a page that doesn't exist
...
exports.heartStore = async (req, res) => {
  ...
  const operator = hearts.includes(req.params.id) ? '$pull' : '$addToSet'; // $addToSet ensures we don't create a duplicate entry
